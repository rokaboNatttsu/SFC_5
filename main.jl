...
β1, β2 = 0.05, 1.0
γ1, γ2 = 0.015, 0.02
δ1, δ2 = fill(0.015, T), 0.3 #   0.02, 0.3
...
function plot_transition()
    plot(p[end-150:end]./p[end-150], label="p")
    plot!(pk[end-150:end]./p[end-150], label="pk")
    savefig("figs/p.png")

    plot(pec[end-150:end]./p[end-150], label="pec")
    plot!(pek[end-150:end]./p[end-150], label="pek")
    savefig("figs/pe.png")

    plot(NLw[end-150:end]./G[end-150], label="NLw")
    plot!(NLi[end-150:end]./G[end-150], label="NLi")
    plot!(NLc[end-150:end]./G[end-150], label="NLc")
    plot!(NLk[end-150:end]./G[end-150], label="NLk")
    plot!(NLb[end-150:end]./G[end-150], label="NLb")
    plot!(NLg[end-150:end]./G[end-150], label="NLg")
    savefig("figs/NL.png")
    ...
    plot(W[end-150:end]./G[end-150], label="W")
    plot!(Wc[end-150:end]./G[end-150], label="Wc")
    plot!(Wk[end-150:end]./G[end-150], label="Wk")
    plot!(Wb[end-150:end]./G[end-150], label="Wb")
    plot!(Wg[end-150:end]./G[end-150], label="Wg")
    savefig("figs/W.png")

    plot(Πc[end-150:end]./G[end-150], label="Πc")
    plot!(Πcc[end-150:end]./G[end-150], label="Πcc")
    plot!(Πcb[end-150:end]./G[end-150], label="Πcb")
    plot!(Πci[end-150:end]./G[end-150], label="Πci")
    savefig("figs/Πc.png")

    plot(Πk[end-150:end]./G[end-150], label="Πk")
    plot!(Πkk[end-150:end]./G[end-150], label="Πkf")
    plot!(Πkb[end-150:end]./G[end-150], label="Πkb")
    plot!(Πki[end-150:end]./G[end-150], label="Πki")
    savefig("figs/Πk.png")

    plot(kc[end-150:end]./g[end-150], label="kc")
    plot!(kk[end-150:end]./g[end-150], label="kk")
    plot!(kg[end-150:end]./g[end-150], label="kg")
    savefig("figs/k.png")

    plot(ic[end-150:end]./g[end-150], label="ic")
    plot!(ik[end-150:end]./g[end-150], label="ik")
    plot!(ig[end-150:end]./g[end-150], label="ig")
    savefig("figs/i.png")

    plot(C[end-150:end]./G[end-150], label="C")
    plot!(Ci[end-150:end]./G[end-150], label="Ci")
    plot!(Cw[end-150:end]./G[end-150], label="Cw")
    ...
    plot!(Ik[end-150:end]./G[end-150], label="Ik")
    plot!(Ig[end-150:end]./G[end-150], label="Ig")
    plot!(G[end-150:end]./G[end-150], label="G")
    ...
    plot(M[end-150:end]./G[end-150], label="M")
    plot!(Mw[end-150:end]./G[end-150], label="Mw")
    plot!(Mi[end-150:end]./G[end-150], label="Mi")
    plot!(Mc[end-150:end]./G[end-150], label="Mc")
    plot!(Mk[end-150:end]./G[end-150], label="Mk")
    savefig("figs/M.png")

    plot(L[end-150:end]./G[end-150], label="L")
    plot!(Lw[end-150:end]./G[end-150], label="Lw")
    plot!(Lc[end-150:end]./G[end-150], label="Lc")
    plot!(Lk[end-150:end]./G[end-150], label="Lk")
    savefig("figs/L.png")

    plot(NWw[end-150:end]./G[end-150], label="NWw")
    plot!(NWi[end-150:end]./G[end-150], label="NWi")
    plot!(NWc[end-150:end]./G[end-150], label="NWc")
    plot!(NWk[end-150:end]./G[end-150], label="NWk")
    plot!(NWb[end-150:end]./G[end-150], label="NWb")
    plot!(NWg[end-150:end]./G[end-150], label="NWg")
    savefig("figs/NW.png")

    plot(Eci[end-150:end]./G[end-150], label="Eci")
    plot!(Ec[end-150:end]./G[end-150], label="Ec")
    plot!(Ecb[end-150:end]./G[end-150], label="Ecb")
    savefig("figs/nominal_Ec.png")

    plot(Eki[end-150:end]./G[end-150], label="Eki")
    plot!(Ek[end-150:end]./G[end-150], label="Ek")
    plot!(Ekb[end-150:end]./G[end-150], label="Ekb")
    ...
    plot(Hw[end-150:end]./G[end-150], label="Hw")
    plot!(Hb[end-150:end]./G[end-150], label="Hb")
    plot!(H[end-150:end]./G[end-150], label="H")
    savefig("figs/H.png")

    plot(Tiw[end-150:end]./G[end-150], label="Tiw")
    plot!(Tii[end-150:end]./G[end-150], label="Tii")
    plot!(Ti[end-150:end]./G[end-150], label="Ti")
    savefig("figs/Ti.png")

    plot(Tew[end-150:end]./G[end-150], label="Tew")
    plot!(Tei[end-150:end]./G[end-150], label="Tei")
    plot!(Tec[end-150:end]./G[end-150], label="Tec")
    plot!(Tek[end-150:end]./G[end-150], label="Tek")
    plot!(Te[end-150:end]./G[end-150], label="Te")
    savefig("figs/Te.png")

    plot(Tfb[end-150:end]./G[end-150], label="Tfb")
    plot!(Tfc[end-150:end]./G[end-150], label="Tfc")
    plot!(Tfk[end-150:end]./G[end-150], label="Tfk")
    plot!(Tf[end-150:end]./G[end-150], label="Tf")
    savefig("figs/Tf.png")
    ...
    plot(Πki[end-150:end]./G[end-150], label="Πki")
    plot!(Πk[end-150:end]./G[end-150], label="Πk")
    plot!(Πkk[end-150:end]./G[end-150], label="Πkk")
    plot!(Πkb[end-150:end]./G[end-150], label="Πkb")
    savefig("figs/Πc.png")
